	...
	*/
	public function __construct() {
		...
		if( isset( $_GET[ 'page' ] ) && 'layers-marketplace' == $_GET[ 'page' ] )
			wp_redirect( 'https://go.elementor.com/layers-wp/?utm_source=layers%20theme&utm_medium=link&utm_campaign=Layers%20Upsell&utm_content=Dashboard%20Menu' );
	...
	public function get_menu_pages(){
		...
		if( !class_exists( 'Elementor\Plugin' ) ){ 
			$pages[ 'layers-marketplace' ] = array(
				'label' => 'Get Elementor',
				'link' => 'https://go.elementor.com/layers-wp/',
			);
		}
...
function layers_options_panel_menu(){
	...
	// Layers Pages
	if( !empty( layers_get_builder_pages() ) ){
